...
datasets, fold_id = [['davis','kiba'][int(sys.argv[1])]], str(sys.argv[4]) 
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        best_ci = 0
        best_epoch = -1
        model_file_name = './NEW_FOLD_RESULTS/model_' + model_st + '_' + dataset + fold_id +  '.model'
        result_file_name = './NEW_FOLD_RESULTS/result_' + model_st + '_' + dataset +  fold_id + '.csv'
